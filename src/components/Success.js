...
export default function Succsses(){
    ...
    return(
        <div className="div-location row">
            <label>הפרטים נוספו בהצלחה</label>
            <div>
                <label>להורדת הפרטים בקובץ Excel</label>
            </div>
                <button className="btn btn-outline-primary opacity-75 col-3" onClick={download}>                
